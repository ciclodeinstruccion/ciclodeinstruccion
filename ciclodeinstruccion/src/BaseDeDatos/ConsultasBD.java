/**
 * Clase desde la que se hacen las diferentes consultas SQL
 */
package BaseDeDatos;
...
public class ConsultasBD {
    ...
    /**
     * Añade un usuario registrado a la base de datos
     * @param r
    ...
    /**
     * Pone en true el atributo baneado de un usuario en la base de datos
     * @param r 
     */
    ...
    /**
     * Pone en false el atributo baneado de un usuario en la base de datos
     * @param r 
     */
    ...
    /**
     * Comprueba si un usuario está baneado.Retorna true si lo esta
     * @param r
     * @return 
     */
    ...
    /**
     * Devuelve un arraylist con los personaje que no tien un usuario
     * @param r
     * @return 
     */
    ...
    /**
     * Devuelve un arraylist con las partidas a las que puedes unirte
     * @param r
     * @return 
     */
    ...
    /**
     * Devuelve un arraylist con las partidas acabadas de un usuario
     * @param r
     * @return 
     */
    ...
    /**
     * Número de partidas jugadas por dos personajes
     * @param personaje1
     * @param personaje2
     * @return 
     */
    ...
    /**
     * Partidas jugadas por un personaje como personaje 1
     * @param personaje
     * @return 
     */
    ...
    /**
     * Partidas jugadas por un personaje como personaje 2
     * @param personaje
     * @return 
     */
    ...
    /**
     * Partidas jugadas por un mipersonaje como personaje 1
     * @param r
     * @param mp
     * @param rival
     * @return 
    ...
    /**
     * Partidas jugadas por un mipersonaje como personaje 2
     * @param r
     * @param mp
     * @param rival
     * @return 
    ...
    /**
     * Partidas ganadas por un mipersonaje como personaje 1
     * @param r
     * @param mp
     * @param rival
     * @return 
    ...
    /**
     * Partidas ganadas por un mipersonaje como personaje 2
     * @param r
     * @param mp
     * @param rival
     * @return 
    ...
    /**
     * Partidas ganadas de un usuario
     * @param r
     * @return 
     */
    ...
    /**
     * Partidas jugadas por un usuario como jugador 1
     * @param r
     * @return 
     */
    ...
    /**
     * Partidas jugadas por un usuario como jugador 2
     * @param r
     * @return 
     */
